      ...
      <div className="overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-lg ">
        ...
        <div className="px-4 py-6 md:px-7 md:py-7 lg:px-8 lg:py-8">
          ...
          {loadingCatalog ? (
            ...
            >
              {/* Skeleton header */}
              <div className="h-6 w-48 rounded-lg bg-white/[0.06] animate-pulse mx-auto mb-8" />
              {/* Skeleton cards */}
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-5 flex gap-4 items-start"
                ...
                >
                  ...
                  <div className="h-6 w-16 rounded bg-white/[0.06] animate-pulse flex-shrink-0" />
                </div>
              ))}
            </div>
          ) : null}
